...
from llama_recipes.datasets.feedback_dataset.feedback_dataset import FeedbackDataset as get_feedback_dataset
from llama_recipes.datasets.judge_dataset import JudgeDataset as get_judge_dataset
...
DATASET_PREPROC = {
    ...
    "feedback_dataset": get_feedback_dataset,
