...
def main(**kwargs):
    ...
    config = AutoConfig.from_pretrained(train_config.model_name, token=train_config.authentication_token)
    if config.model_type == "mllama":
        is_vision = True
        model = MllamaForConditionalGeneration.from_pretrained(
            train_config.model_name,
            token=train_config.authentication_token,
    ...
    print(f"--> Dataset_lang = {dataset_config.lang}")
